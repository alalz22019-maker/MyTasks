...
/* جدول التغطية: الاحتياط التلقائي لكل مسؤول (لعمود Secondary Owner في راصد) */
export const COVERAGE_MAP = {
  'م. علي الزهراني': 'أ. نورة التركي',
  'أ. نورة التركي': 'م. علي الزهراني',
  'م. حمادي الشعائره': 'أ. محمد القحطاني',
  'أ. محمد القحطاني': 'م. حمادي الشعائره',
  'أ. صالحة المالكي': 'أ. صفا الشهري',
  'أ. صفا الشهري': 'أ. صالحة المالكي',
  'أ. تركي السلمان': 'م. علي الزهراني',
  'أ. ريما الفهيد': 'م. علي الزهراني',
  'أ. فيصل الرحيمي': 'م. علي الزهراني',
}
